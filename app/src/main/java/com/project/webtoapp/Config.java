...
public class Config {
    ...
    public static final Object[] TITLES = new Object[]{"title"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"file:///android_asset/video.html "};
    ...
    public static final int INTERSTITIAL_INTERVAL = 15;
}
